...
public static class InventoryManager
{
    ...
    {
        CraftingService.Craft(clientId, tick, slot, tileX, tileY);
    }
    ...
    public static void BuildStructure(ushort clientId, ushort tick, int slot, int tileX, int tileY)
    {
        ...
        bool buildSuccessful = BuildingService.Build(PlayerManager.Singleton.playersByClientId[clientId].inventory.slots[slot], MapUtil.GetTile(tileX, tileY));
        if (buildSuccessful)
