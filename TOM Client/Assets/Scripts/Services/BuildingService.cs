...
public static class BuildingService
{
    ...
    private static void AddRecipe(string originalStructureName, string itemName, string resultStructureName)
    {
        ...
        Structure originalStructure = StructureService.structuresByName[originalStructureName];
        Structure resultStructure = StructureService.structuresByName[resultStructureName];
