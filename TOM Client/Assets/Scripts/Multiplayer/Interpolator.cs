...
public class Interpolator : MonoBehaviour
{
    ...
    [SerializeField] private float timeToReachTarget = 0.0625f;
    [SerializeField] private float movementThreshold = 0.0625f;
    ...
    public void NewUpdate(ushort tick, Vector2 position)
    {
